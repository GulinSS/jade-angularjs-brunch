...
(function() {
  ...
  module.exports = JadeAngularJsCompiler = (function() {
    ...
    JadeAngularJsCompiler.prototype.setupModule = function(pair) {
      var copyfolder, jsFileName, moduleName, modulePath, result, virtualPathGen, vpath, _i, _len, _ref;
      ...
      _ref = pair.path.slice(2, pair.path.length - 1);
    ...
    JadeAngularJsCompiler.prototype.prepareResult = function(compiled) {
      ...
      pathes = ((function() {
        ...
        for (_i = 0, _len = compiled.length; _i < _len; _i++) {
          result = compiled[_i];
          if (result.path === sysPath.normalize(publicPath + '/js/dontUseMe')) {
